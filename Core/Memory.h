...
extern CONSTEXPR long address_of_virtual_func(Type *arg)
{ return *reinterpret_cast<long *>(*reinterpret_cast<long *>(&arg)); };

/* change address to integer
 * param[a]: pointer
 */
extern inline unsigned long address_to_integer(const void *a);
 ...
 */
extern void mem_copy(void *dst, void *src, const size_type size);
 ...
 * param[size]: the size required to copy
 */
extern void mem_rcopy(void *dst, void *src, const size_type size);
 ...
 * param[size]: the size required to copy
 */
extern void mem_scopy(void *dst, void *src, const size_type size);
 ...
 */
extern void mem_backward(void *begin, const size_type size, const size_type move_distance);
 ...
 * param[move_distance]: the byte's distance required to move
 */
extern void mem_forward(void *begin, const size_type size, const size_type move_distance);
 ...
 * param[size]: the size required to copy
 */
extern void mem_move(void *dst, void *src, const size_type size);
 ...
 */
extern int mem_compare(void *arg1, void *arg2, const size_type size);
 ...
 */
extern void mem_swap(void *arg1, void *arg2, const size_type size);

// set memory to 0
extern void mem_clear(void *dst, const size_type size);

 ...
 */
void mem_copy(void *dst, void *src, const size_t size);
 ...
 * param[size]: the size required to copy
 */
void mem_rcopy(void *dst, void *src, const size_t size);
 ...
 * param[size]: the size required to copy
 */
void mem_scopy(void *dst, void *src, const size_t size);
 ...
 */
void mem_backward(void *begin, const size_t size, const size_t move_distance);
 ...
 * param[move_distance]: the byte's distance required to move
 */
void mem_forward(void *begin, const size_t size, const size_t move_distance);
 ...
 */
int mem_compare(void *arg1, void *arg2, const size_t size);
 ...
 */
void mem_swap(void *arg1, void *arg2, const size_t size);

// set memory to 0
void mem_clear(void *dst, const size_t size);
